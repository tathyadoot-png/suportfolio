...
const JalJeevanSection = ({ lang }: JalJeevanSectionProps) => {
  ...
  return (
    <section className="bg-white py-16 md:py-24 relative overflow-hidden" id="jalJeevan">
      {/* Dynamic Background Shapes */}
      <div className="absolute top-0 left-0 w-64 h-64 bg-green/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs font-black uppercase tracking-[0.3em] text-green">
                  {isHi ? "शुद्ध जल – स्वस्थ जीवन – सशक्त मध्यप्रदेश" : "Pure Water – Healthy Life – Empowered MP"}
                </span>
              </div>
              <p className="font-martel text-gray-700 text-lg md:text-xl leading-relaxed">
                {isHi 
              ...
              <div className="p-6 bg-gray-50 rounded-[2rem] border-l-8 border-green">
                <p className="font-martel text-gray-600 italic text-base">
                  {isHi 
            ...
            {/* 2. Key Works Grid */}
            <div className="space-y-6">
              <h4 className="text-xl font-gotu font-bold text-gray-900 flex items-center gap-3">
                <Activity className="text-green" /> {isHi ? "नेतृत्व में हो रहे प्रमुख कार्य" : "Key Initiatives"}
              </h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3 p-4 bg-white border border-gray-100 rounded-2xl shadow-sm">
                    <CheckCircle2 className="w-5 h-5 text-green shrink-0 mt-0.5" />
                    <span className="font-martel text-sm text-gray-600">{item}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                <h4 className="text-xl font-gotu font-bold text-primary flex items-center gap-3">
                  <Sun size={24} /> {isHi ? "दूरस्थ एवं जनजातीय क्षेत्रों पर विशेष फोकस" : "Tribal Focus"}
                </h4>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-2 font-martel text-sm text-gray-500">
                      <div className="w-1.5 h-1.5 rounded-full bg-primary" /> {p}
                    </li>
                  ))}
                </ul>
              </div>
              <div className="bg-green p-8 rounded-[3rem] text-white relative shadow-xl overflow-hidden">
                <Heart className="absolute -right-4 -bottom-4 w-24 h-24 opacity-10" />
                <p className="relative z-10 font-martel italic text-lg leading-relaxed">
                  {isHi 
                    ? "“स्वच्छ पेयजल केवल सुविधा नहीं, बल्कि जनस्वास्थ्य की आधारशिला है।”" 
                    : "“Clean water is the foundation of public health.”"}
                </p>
                <span className="block mt-4 text-xs font-bold uppercase tracking-widest opacity-70">— Smt. Sampatiya Uikey</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="relative">
              <div className="rounded-[4rem] overflow-hidden shadow-2xl border-[12px] border-gray-50 h-[500px] md:h-[650px]">
                <img src={img3} className="w-full h-full object-cover" alt="Minister" />
              </div>
              
              {/* Overlapping Impact Cards */}
              <div className="absolute -bottom-6 -left-6 md:-left-12 bg-white p-6 rounded-[2.5rem] shadow-2xl border border-gray-100 max-w-[280px]">
                <h5 className="font-gotu font-bold text-secondary mb-3">{isHi ? "जनस्वास्थ्य दृष्टिकोण" : "Public Health Focus"}</h5>
                <div className="space-y-2">
                  {[
                    ...
                    <div key={i} className="text-xs font-martel text-gray-400 flex items-center gap-2">
                      <div className="w-1 h-1 rounded-full bg-green" /> {txt}
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="bg-secondary p-8 rounded-[3rem] text-white space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-xl font-gotu font-bold leading-tight">{isHi ? "लक्ष्य: जल-सुरक्षित मध्यप्रदेश" : "Goal: Water-Secure MP"}</h4>
                  <p className="text-xs opacity-60 uppercase tracking-widest font-bold">The Ultimate Vision</p>
                </div>
              </div>
              <p className="font-martel text-sm md:text-base leading-relaxed opacity-90">
                {isHi 
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                {["समानता", "स्वास्थ्य", "महिला सम्मान", "ग्रामीण सशक्तिकरण"].map((tag, i) => (
                  <span key={i} className="px-3 py-1.5 bg-white/10 border border-white/10 rounded-xl text-[10px] font-black uppercase tracking-tighter">
                    {isHi ? tag : tag}
                  </span>
                ))}
              </div>
